...
const Footer = () => {
  return (
    <footer className="px-6 md:px-12 py-12 bg-[#2A254B] mt-12">
        ...
        <div className="text-white w-full sm:w-auto">
          ...
          <div className="mt-4">
            <input
              ...
              className="w-full sm:w-[250px] lg:w-[300px] h-[48px] p-2 bg-transparent opacity-75 border border-white rounded-md"
            />
